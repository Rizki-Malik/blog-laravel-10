    ...
    <div class="flex flex-wrap justify-between items-center">
      ...
      <div class="flex items-center lg:order-2">
        ...
        <button
          ...
          class="p-2 mr-4 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
        >
        ...
        <button
          type="button"
          class="flex mx-4 text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
          id="user-menu-button"
          aria-expanded="false"
          ...
          >
            <li>
                <form action="/logout" method="POST">
                  @csrf
                  <button type="submit" class="flex justify-between items-center py-2 px-[69px] text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem" tabindex="-1">
                      <span class="flex">
