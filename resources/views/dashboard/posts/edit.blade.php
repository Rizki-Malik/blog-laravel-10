        ...
        <div class="flex-grow bg-white dark:bg-gray-900 overflow-y-auto">
            ...
            <div class="">
                <div class="py-8 px-4 mx-auto max-w-7xl lg:py-16">
                    <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Editing is the art of refining words, sculpting thoughts, and perfecting the canvas of your expression.</h2>
                    <form action="/dashboard/posts/{{ $post->slug }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                            ...
                            <div>
                                ...
                                <img src="{{ $post->image ? asset('storage/' . $post->image) : '' }}" class="img-preview rounded-md">
                            ...
                            <div class="sm:col-span-2">
                                <label for="body" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Body</label>
                                    ...
                                    @enderror
                                <textarea id="body" name="body" class="h-full">{{ old('body', $post->body) }}</textarea>
                            </div>
                        </div>
...
<script>
    ...
    slug.addEventListener('click', updateSlug);
