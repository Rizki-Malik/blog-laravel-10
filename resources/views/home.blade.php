        ...
        <div class="flex flex-wrap">
            ...
            <div class="w-full self-end px-4 lg:w-1/2">
                <div class="relative lg:right-0">
                    <img src="/img/rizki.png" alt="Rizki Malik" class="relative z-10 max-w-full mx-auto">
        ...
        <div class="flex flex-wrap">
            ...
            <div class="w-full px-4 lg:w-1/2">
                ...
                <div class="flex items-center">
                    ...
                    <!-- Facebook -->
                    <a href="https://www.facebook.com/MuhammadRizkiMalikAziz" target="_blank" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 hover:border-primary hover:bg-primary hover:text-white text-slate-300 transition duration-200 ease-in-out">
                        <svg role="img" width="20" class="fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <!-- Github -->
                    <a href="https://github.com/Rizki-Malik" target="_blank" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 hover:border-primary hover:bg-primary hover:text-white text-slate-300 transition duration-200 ease-in-out">
                        <svg role="img" width="20" class="fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <title>GitHub</title>
                    ...
                    <a href="https://www.linkedin.com/in/muhammad-rizki-malik-aziz-4143581a6/" target="_blank" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 hover:border-primary hover:bg-primary hover:text-white text-slate-300 transition duration-200 ease-in-out">
                        <svg role="img" width="20" class="fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
