<nav class="mx-auto flex max-w-screen-2xl items-center justify-between p-6 lg:px-8" aria-label="Global">
    ...
    <div class="hidden lg:flex lg:gap-x-12">
        <a href="/" class="text-sm font-semibold leading-6 {{ ($active == 'home' ? 'text-blue-800' : 'text-slate-100') }}">Home</a>
        <a href="/about" class="text-sm font-semibold leading-6 {{ ($active == 'about' ? 'text-blue-800' : 'text-slate-100') }}">About</a>
        <a href="/posts" class="text-sm font-semibold leading-6 {{ ($active == 'blog' ? 'text-blue-800' : 'text-slate-100') }}">Blog</a>
        <a href="/categories" class="text-sm font-semibold leading-6 {{ ($active == 'categories' ? 'text-blue-800' : 'text-slate-100') }}">Categories</a>
    </div>       
    <div class="hidden lg:flex lg:flex-1 lg:justify-end">
        <a href="/login" class="text-sm font-semibold leading-6 {{ ($active == 'login' ? 'text-blue-800' : 'text-slate-100') }}">Log in <span aria-hidden="true">&rarr;</span></a>
    </div>
</nav>
